...
def process_folder_to_json(folder_path, icd9_file, output_json_file):
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(".csv"):
            ...
            if not disease_id:
                with open('diseases_not_found.txt', 'a') as f:
...
# Example usage
folder_path = "/mnt/0C6C8FC06C8FA2D6/sparse_results_3digit"
icd9_file = "three_digit_icd9_codes.csv"
output_json_file = "/mnt/0C6C8FC06C8FA2D6/sparse_kg_data_3digits.json"
