...
# output_csv = '/mnt/0C6C8FC06C8FA2D6/output/pubmed_data.csv'
# output_json = '/mnt/0C6C8FC06C8FA2D6/output/pubmed_data.json'
...
#         # Namespace for PubMed XML
#         ns = {'medline': 'http://www.nlm.nih.gov/medline'}
        
#         data = []
#         for article in root.findall('.//medline:PubmedArticle', ns):
#             pmid = article.find('.//medline:PMID', ns).text
#             title = article.find('.//medline:ArticleTitle', ns).text
#             abstract_elem = article.find('.//medline:AbstractText', ns)
...
# # Save the combined data to CSV and JSON
...
# # Define paths
# input_folder = '/mnt/0C6C8FC06C8FA2D6/medline_data'
# output_folder = '/mnt/0C6C8FC06C8FA2D6/output'
...
#         output_csv = os.path.join(output_folder, f'pubmed24n{file_number}.csv')
#         output_json = os.path.join(output_folder, f'pubmed24n{file_number}.json')
