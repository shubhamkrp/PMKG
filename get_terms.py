    ...
    for term in terms:
        ...
        for line in lines:
            if line.startswith("name:"):
                ...
                is_a_disease = line.split(":")[1].strip()
                extracted_is_disease.append(is_a_disease)
...
if __name__=="__main__":
    ...
    extracted_data.to_csv("OUTPUT/relationship1.csv",sep=",",index=False)
